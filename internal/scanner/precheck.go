...
// no raw socket privilege (Linux), Npcap is missing or not in
// WinPcap-API-compatible mode (Windows), or BPF read access is missing
// (macOS — install ChmodBPF or run with sudo), and the rest of the
